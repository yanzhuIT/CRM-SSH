            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=370><SPAN 
                  ...
                  style="FONT-WEIGHT: bold; VISIBILITY: hidden; COLOR: white">Please input your username</SPAN></TD></TR>
              <TR>
                <TD style="HEIGHT: 28px">password:</TD>
                <TD style="HEIGHT: 28px"><INPUT id=txtPwd style="WIDTH: 130px" 
                  type=password name=password></TD>
                <TD style="HEIGHT: 28px"><SPAN id=RequiredFieldValidator4 
                  style="FONT-WEIGHT: bold; VISIBILITY: hidden; COLOR: white">Please input your password</SPAN></TD></TR>
              <TR>
