...
<BODY>
	...
	<FORM id=form1 name=form
		action="${pageContext.request.contextPath }/visit_addVisit.action"
		method="post">
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：用户拜访客户管理 &gt; 添加客户拜访</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							...
							<TR>
								...
								<td><INPUT class=textbox id=sChanne1 style="WIDTH: 180px"
									maxLength=50 name="vaddress"></td>
							</TR>
							<TR>
								<td>拜访内容 ：</td>
								<td><INPUT class=textbox id=sChanne2 style="WIDTH: 180px"
									maxLength=50 name="vcontent"></td>
							</TR>
							<tr>
